...
$regStatus="Password mismatch ! registration failed";
}
...
if(isset($_POST['button']))
{
echo "<br><font color=white>$regStatus<br>";
}
?> 
<br>
<a href=login.php><font color="white" size=10px>log in</font> </a>
