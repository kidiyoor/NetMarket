...
if(mysql_num_rows($r)==0)
	...
	{$r=mysql_query("select * from data where  (stockDate BETWEEN '$y-$key-01' AND '$y-$key-31') or (stockDate BETWEEN '$p-$key-01' AND '$p-$key-31')or (stockDate BETWEEN '$l-$key-01' AND '$l-$key-31')");
